...
#         self.wall = wall
#     def render1(self):
#         if self.wall.orient == 'H':
#             # Render a horizontal wall
#             x1, x2 = self.wall.endpoints
#             y = self.wall.axis_pos
#             glBegin(GL_QUADS)
#             glVertex3f(x1, y - self.wall.width / 2, 0)
#             glVertex3f(x2, y - self.wall.width / 2, 0)
#             glVertex3f(x2, y + self.wall.width / 2, 0)
#             glVertex3f(x1, y + self.wall.width / 2, 0)
#             glEnd()
#         elif self.wall.orient == 'V':
#             # Render a vertical wall
#             y1, y2 = self.wall.endpoints
#             x = self.wall.axis_pos
#             glBegin(GL_QUADS)
#             glVertex3f(x - self.wall.width / 2, y1, 0)
#             glVertex3f(x + self.wall.width / 2, y1, 0)
#             glVertex3f(x + self.wall.width / 2, y2, 0)
#             glVertex3f(x - self.wall.width / 2, y2, 0)
#             glEnd()
